...
class SegmentNet(nn.Module):
    # the input of the seg class is the chennel numble and initial weight T/F
    def __init__(self, in_channels=3, init_weights=True):
        ...
        self.layer1 = nn.Sequential(
            ...
            # add more conv+normal+acti to get high level info
        ...
        if init_weights == True:
            pass
# set up reht relation of the layer
    def forward(self, x):
        x1 = self.layer1(x)
        x2 = self.layer2(x1)
        x3 = self.layer3(x2)
